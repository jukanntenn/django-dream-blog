...
CONSTANCE_DATABASE_PREFIX = "constance:django_dream_blog:"
CONSTANCE_CONFIG = {
    "BLOGGER": ("追梦人物", "", str),
    "SLOGAN": ("一直走在追梦的路上。", "", str),
    "SOCIAL_LINK_GITHUB": ("", "Social Link GitHub", str),
    "SOCIAL_LINK_X": ("", "Social Link X"),
...
CONSTANCE_CONFIG_FIELDSETS = {
    "General Options": ("BLOGGER", "SLOGAN"),
    "Socail Links": (
        "SOCIAL_LINK_GITHUB",
        "SOCIAL_LINK_X",
